...
"[project]/src/app/la/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LuChat() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LuChat.useEffect": ()=>{
            const saved = localStorage.getItem("la2_chats");
            if (saved) {
                try {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LuChat.useEffect": ()=>{
            ...
            setChats({
                "LuChat.useEffect": (prev)=>{
                    const idx = prev.findIndex({
                        "LuChat.useEffect.idx": (c)=>c.id === activeChatId
                    }["LuChat.useEffect.idx"]);
                    ...
                    localStorage.setItem("la2_chats", JSON.stringify(updated));
                    return updated;
                }
            }["LuChat.useEffect"]);
        }
    ...
    const deleteChat = (e_0, id)=>{
        e_0.stopPropagation();
        const newChats = chats.filter((c_0)=>c_0.id !== id);
        setChats(newChats);
        localStorage.setItem("la2_chats", JSON.stringify(newChats));
        if (activeChatId === id) {
    ...
    const fetchSession = async ()=>{
        try {
            ...
            console.error("Backend offline?", e_1);
        }
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LuChat.useEffect": ()=>{
            ...
            wsRef.current = ws;
            ws.onmessage = ({
                "LuChat.useEffect": (e_2)=>{
                    const data_0 = JSON.parse(e_2.data);
                    if (data_0.type === "message") {
                        setIsStreaming(true);
                        setMessages({
                            "LuChat.useEffect": (prev_1)=>{
                                const last_0 = prev_1[prev_1.length - 1];
                                // If last message is assistant, append. Otherwise create new.
                                if (last_0 && last_0.role === "assistant") {
                                    const updated_0 = [
                                        ...prev_1
                                    ];
                                    updated_0[updated_0.length - 1] = {
                                        ...last_0,
                                        content: last_0.content + data_0.content
                                    };
                                    return updated_0;
                                } else {
                                    return [
            ...
            ws.onclose = ({
                "LuChat.useEffect": ()=>setIsStreaming(false)
            })["LuChat.useEffect"];
            return ({
                "LuChat.useEffect": ()=>{
                    ws.close();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex h-screen bg-[#0D1117] text-[#E6EDF3] font-sans",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                className: "hidden md:flex flex-col w-64 bg-[#161B22] border-r border-[#30363D]",
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$plus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Plus$3e$__["Plus"], {
                                    ...
                                    fileName: "[project]/src/app/la/page.tsx",
                                    lineNumber: 194,
                                    columnNumber: 13
                                }, this),
                                " New Chat"
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                className: "text-xs font-semibold text-[#8B949E] px-2 py-2 uppercase tracking-wider",
                                children: "History"
                            }, void 0, false, {
                                fileName: "[project]/src/app/la/page.tsx",
                                lineNumber: 199,
                            ...
                            chats.map((chat_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    onClick: ()=>loadChat(chat_0),
                                    className: `group flex items-center gap-2 px-3 py-2 rounded-md cursor-pointer text-sm transition-colors ${activeChatId === chat_0.id ? "bg-[#30363D] text-[#E6EDF3]" : "text-[#8B949E] hover:bg-[#21262D] hover:text-[#C9D1D9]"}`,
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            children: chat_0.title || "Untitled Chat"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/la/page.tsx",
                                            lineNumber: 202,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trash$2d$2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Trash2$3e$__["Trash2"], {
                                            ...
                                            onClick: (e_3)=>deleteChat(e_3, chat_0.id)
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/la/page.tsx",
                                            lineNumber: 203,
                                            columnNumber: 15
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "p-4 border-t border-[#30363D] text-xs text-[#8B949E] text-center",
                        children: "LA² Local History"
                    }, void 0, false, {
                        fileName: "[project]/src/app/la/page.tsx",
                        lineNumber: 207,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                className: "flex flex-col flex-1 items-center overflow-hidden relative",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "w-full max-w-3xl flex flex-col flex-1 relative z-10",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                            className: "px-6 py-4 flex items-center justify-between border-b border-[#30363D] bg-[#0D1117]/80 backdrop-blur-sm z-20",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex items-center gap-2 text-lg font-medium text-[#E6EDF3]",
                                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex-1 overflow-y-auto px-4 md:px-0 py-6 space-y-6",
                            children: [
                                messages.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex flex-col items-center justify-center h-full text-[#8B949E] opacity-50 select-none",
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "Start a new conversation with LA²"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/la/page.tsx",
                                            lineNumber: 229,
                                            columnNumber: 17
                                ...
                                messages.map((msg, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: `px-5 py-3.5 rounded-2xl max-w-[85%] text-sm leading-relaxed shadow-sm ${msg.role === "user" ? "bg-[#1F6FEB] text-white rounded-br-none" : "bg-[#21262D] text-[#E6EDF3] border border-[#30363D] rounded-bl-none"}`,
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                isStreaming && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex gap-4 max-w-2xl mx-auto w-full justify-start",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "bg-[#21262D] px-5 py-3.5 rounded-2xl rounded-bl-none border border-[#30363D] flex gap-1 items-center h-10",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "w-2 h-2 bg-[#8B949E] rounded-full animate-bounce [animation-delay:-0.3s]"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/la/page.tsx",
                                                lineNumber: 240,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "w-2 h-2 bg-[#8B949E] rounded-full animate-bounce [animation-delay:-0.15s]"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/la/page.tsx",
                                                lineNumber: 241,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "w-2 h-2 bg-[#8B949E] rounded-full animate-bounce"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/la/page.tsx",
                                                lineNumber: 242,
                                                columnNumber: 19
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("footer", {
                            className: "p-4 md:p-6 bg-gradient-to-t from-[#0D1117] via-[#0D1117] to-transparent",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            value: input,
                                            onChange: (e_4)=>setInput(e_4.target.value),
                                            onKeyDown: (e_5)=>e_5.key === "Enter" && sendMessage(),
                                            placeholder: "Ask about loans, eligibility, or coding...",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            className: `absolute right-2 top-2 bottom-2 px-4 rounded-lg font-medium text-sm transition-all ${isStreaming || !input.trim() ? "bg-[#30363D] text-[#8B949E] cursor-not-allowed" : "bg-[#1F6FEB] hover:bg-[#388BFD] text-white shadow-md hover:shadow-lg active:scale-95"}`,
                                            children: "Send"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/la/page.tsx",
                                            lineNumber: 252,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "text-center mt-3 text-xs text-[#484F58]",
                                    children: "LA² can make mistakes. Verify important financial information."
                                }, void 0, false, {
                                    fileName: "[project]/src/app/la/page.tsx",
                                    lineNumber: 256,
                                    columnNumber: 13
...
_s(LuChat, "AxIHnaW6Ezk4UBfKn1OrRfpOgrg=");
_c = LuChat;
var _c;
__turbopack_context__.k.register(_c, "LuChat");
...
//# sourceMappingURL=_91e44b75._.js.map